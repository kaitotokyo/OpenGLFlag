...
public class Constant 
{
	...
	final static int NUMROWS = 7;//旗子行列数
	...
	final static float RSTER = 0.75f/NUMROWS;//计算粒子行间距
	final static float CSTER = 1.0f/NUMCOLS;//计算粒子列间距
	...
	final static float GRAVITY = -0.3f;//重力
	...
	static boolean isC = false;//是否开启碰撞检测
