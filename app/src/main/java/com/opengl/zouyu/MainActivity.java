    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bt1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				//取消固定粒子
				MainActivity.this.msv.mRenderer.pc.particles[0][0].bLocked = false;
				MainActivity.this.msv.mRenderer.pc.particles[Constant.NUMROWS][0].bLocked = false;
			}
		});
        ...
        bt2.setOnClickListener(new OnClickListener() {
        	...
        	public void onClick(View v) {
        		...
        		{
        			MainActivity.this.msv.mRenderer.pc.initalize();//重置粒子
        		}
        	}
        });
        ...
        bt3.setOnClickListener(new OnClickListener() {
        	@Override
        	public void onClick(View v) {
        		MainActivity.this.msv.nowId = (MainActivity.this.msv.nowId+1)%3;//切换id
        	}
        });
